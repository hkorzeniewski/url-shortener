...
class EncodingTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.response_with_url = self.client.get(f"http://localhost:8000/encode/{self.url_to_encode}")
...
class DecodingTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.response_with_url = self.client.get(f"http://localhost:8000/decode/{self.url_to_decode}")
        self.data = json.loads(self.response_with_url.content)
